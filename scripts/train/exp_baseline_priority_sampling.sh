#!/bin/bash
#SBATCH --job-name=PrioritySamplingBaseline-Qwen2.5-7B-Dsitialled
...
"${CONDA_BIN_PATH}python" -m verl.recipe.dapo.src.main_dapo \
    ...
    +trainer.pass_rate_threshold=1.0 \
    trainer.default_local_dir='/mnt/sharefs/users/chengqian.gao/priority_sampling_baseline_qwen25_7b_dist' $@