...
RESUME_CKPT_DIR_NAME="/mnt/sharefs/users/haonan.li/Reasoning360/checkpoints/Difficulty-Aware-RL/final-baseline-DeepSeek-R1-Distill-Qwen-7B-434164"  # Fill in the checkpoint directory name to resume from, otherwise from scratch
