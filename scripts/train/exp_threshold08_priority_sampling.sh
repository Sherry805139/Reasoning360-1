#!/bin/bash
#SBATCH --job-name=PrioritySamplingThreshold08
...
"${CONDA_BIN_PATH}python" -m verl.recipe.dapo.src.main_dapo \
    ...
    +trainer.pass_rate_threshold=0.8 \
    trainer.default_local_dir='/mnt/sharefs/users/chengqian.gao/priority_sampling_threshold_08' $@