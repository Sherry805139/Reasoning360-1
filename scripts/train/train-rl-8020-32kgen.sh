#!/bin/bash
#SBATCH --job-name=80_20-16node-32kgen-qwen32b-amthink
...
RESUME_CKPT_DIR_NAME="458678-16node-32kgen-80_20-qwen32b-amthink"  # Fill in the checkpoint directory name to resume from, otherwise from scratch
