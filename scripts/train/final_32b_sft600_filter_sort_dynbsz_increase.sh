#!/bin/bash
#SBATCH --job-name=final-32b-sft600-filter_sort_dynbsz_increase
...
RESUME_CKPT_DIR_NAME="/mnt/sharefs/users/haonan.li/Reasoning360/checkpoints/Reasoning360/final-32b-sft600-filter_sort_dynbsz_increase-checkpoint-600-505087"  # Fill in the checkpoint directory name to resume from, otherwise from scratch
...
# =================== Model ===================
BASE_MODEL=/mnt/sharefs/users/shibo.hao/Qwen2.5-32B-base-AM-thinking-distilled-v1-old/checkpoint-600
