#!/bin/bash
#SBATCH --job-name=llama3.1-70b-distill-fsdp-v2
#SBATCH --nodes=32
#SBATCH --ntasks=32
...
export STEM_LLM_JUDGE_URL="http://azure-uk-hpc-H200-instance-xxx:8000"  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
