...
train_files="['${hitab_train_path_s2}', '${hitab_train_path_s2}', '/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_2_sftjudge.parquet', '/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_2_sftjudge_ke.parquet', '/home/hmpiao/adv_reason/Reasoning360/data/train/table__hitab_0.2k_2_sftjudge_ke.parquet']"  # Use math as example, add to more tasks as needed
test_files="['${hitab_test_path}']"  # Use math as example, add to more tasks as needed
...
"${CONDA_BIN_PATH}python" -m verl.recipe.dapo.src.main_dapo \
    ...
    +trainer.val_generations_to_log_to_swanlab=30 \
