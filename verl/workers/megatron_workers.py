...
class ActorRolloutRefWorker(MegatronWorker, DistProfilerExtension):
    ...
    @register(dispatch_mode=Dispatch.MEGATRON_PP_DUMMY_PROTO) # NOTE: added by Reasoning360
    ...
    @register(dispatch_mode=Dispatch.DP_COMPUTE_PROTO) # NOTE: added by Reasoning360
...
class CriticWorker(MegatronWorker, DistProfilerExtension):
    ...
    @register(dispatch_mode=Dispatch.MEGATRON_COMPUTE_PROTO) # NOTE: added by Reasoning360
