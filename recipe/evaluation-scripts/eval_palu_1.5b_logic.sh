#!/bin/bash
#SBATCH --job-name=eval-math-palu-math500
#SBATCH --nodes=2
#SBATCH --ntasks=2
...
export STEM_LLM_JUDGE_URL="http://10.24.2.84:8000"  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
...
#             807069      main eval-mat chengqia  R       0:01      2 fs-mbz-gpu-[259,370]
test_files="['${logic_test_path}']"


# =================== Model ===================
BASE_MODEL=/mnt/sharefs/users/chengqian.gao/checkpoints/PALU/756464-math-1.5b-dalu-th8-alpha5-16k-20epoch/global_step_400/actor
