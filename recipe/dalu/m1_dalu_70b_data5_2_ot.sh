#!/bin/bash
#SBATCH --job-name=rl-70b-ot-data_5_2_mix6
#SBATCH --nodes=16
#SBATCH --ntasks=16
...
# =================== Model ===================
BASE_MODEL=/lustrefs/users/runner/workspace/checkpoints/huggingface/sft/mid4_sft_reasoning_ot_cos_epoch/checkpoints/checkpoint_0006300
