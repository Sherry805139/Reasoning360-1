#!/bin/bash
#SBATCH --job-name=eval-math-1.5b-base
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Test (test)
test_aime24=${TEST_DATA_DIR}/aime24_x8.parquet
test_math500=${TEST_DATA_DIR}/math_500_x4.parquet
test_minervamath=${TEST_DATA_DIR}/minervamath_x4.parquet
test_amc23=${TEST_DATA_DIR}/amc23_x4.parquet
test_olympiadbench=${TEST_DATA_DIR}/olympiadbench_x4.parquet
...
actor_ppo_max_token_len=$(( (max_prompt_length + max_response_length) * 8))  # increase this to speed up model forward & backward but note memory overflow
infer_ppo_max_token_len=$(( (max_prompt_length + max_response_length) * 8))  # increase this to speed up modelforward, but note memory overflow
offload=False
