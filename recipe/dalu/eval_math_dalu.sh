#!/bin/bash
#SBATCH --job-name=eval-math-1.5b-dalu
#SBATCH --nodes=2
#SBATCH --ntasks=2
...
export STEM_LLM_JUDGE_URL="http://10.24.2.95:8000"  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
...
# Math (train)
math_train_path=${TRAIN_DATA_DIR}/math__deepscaler_train_8k.parquet

# Test (test)
test_aime24=${TEST_DATA_DIR}/aime24_x32.parquet
test_math500=${TEST_DATA_DIR}/math_500_x10.parquet
test_minervamath=${TEST_DATA_DIR}/minervamath_x10.parquet
test_amc23=${TEST_DATA_DIR}/amc23_x10.parquet
test_olympiadbench=${TEST_DATA_DIR}/olympiadbench_x10.parquet
test_ood_supergpqa=${TEST_DATA_DIR}/stem__supergpqa_1k.parquet
test_ood_ifeval=${TEST_DATA_DIR}/ood__ifeval_541.parquet
test_ood_stem=${TEST_DATA_DIR}/stem__test_256_x4.parquet
test_ood_logic=${TEST_DATA_DIR}/logic__test_256_x4.parquet
test_ood_livebench_reasoning=${TEST_DATA_DIR}/ood__livebench_reasoning_150.parquet

train_files="['${math_train_path}']"

test_files="['${test_olympiadbench}']"

# =================== Model ===================
BASE_MODEL=/mnt/sharefs/users/chengqian.gao/checkpoints/PALU/717206-math-1.5b-dalu-th6-alpha2-16k-10epoch/global_step_220/actor
