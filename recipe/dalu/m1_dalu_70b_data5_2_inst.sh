#!/bin/bash
#SBATCH --job-name=rl-70b-inst-data_5_2_mix6
#SBATCH --nodes=16
#SBATCH --ntasks=16
...
# =================== Model ===================
BASE_MODEL=/lustrefs/users/runner/workspace/checkpoints/huggingface/sft/mid4_sft_instruct_cos_epoch/checkpoints/checkpoint_0000900
