#!/bin/bash
#SBATCH --job-name=multi-domain-1.5b-stage-based-budgeting-16k-10epoch
#SBATCH --nodes=4
#SBATCH --ntasks=4
...
export STEM_LLM_JUDGE_URL="http://10.24.0.112:8000"  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
