#!/bin/bash
#SBATCH --job-name=eval-math-1.5b-shorterbetter
#SBATCH --nodes=4
#SBATCH --ntasks=4
...
test_files="['${test_aime24}', '${test_math500}', '${test_minervamath}', '${test_amc23}', '${test_olympiadbench}' ]"
# =================== Model ===================
BASE_MODEL=Justin6657/SB_DS1.5B_alpha_2
