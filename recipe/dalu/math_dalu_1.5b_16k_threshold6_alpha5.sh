#!/bin/bash
#SBATCH --job-name=math-1.5b-dalu-th6-alpha5-16k-20epoch
#SBATCH --nodes=2
#SBATCH --ntasks=2
...
# Math (train)
math_train_path=${TRAIN_DATA_DIR}/math__deepscaler_train_12k.parquet
...
"${CONDA_BIN_PATH}python" -m recipe.dalu.main_dalu \
    ...
    +trainer.quantile_interval=0.5 \
    +data.dynamic_filtering=False \
    +data.pass_rate_upper_bound=0.6 \
