#!/bin/bash
#SBATCH --job-name=eval-math-1.5b-step440
#SBATCH --nodes=4
#SBATCH --ntasks=4
...
# =================== Model ===================
BASE_MODEL=/mnt/sharefs/users/chengqian.gao/checkpoints/PALU/756464-math-1.5b-dalu-th8-alpha5-16k-20epoch/global_step_440/actor
