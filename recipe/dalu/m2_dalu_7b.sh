#!/bin/bash
#SBATCH --job-name=dalu-7b-data_5_3
#SBATCH --nodes=32
#SBATCH --ntasks=32
...
export STEM_LLM_JUDGE_URL="http://azure-uk-hpc-H200-instance-099:8000"  # Fill in the llm-as-judge hosted URL, currently used only in 'STEM' domain
...
TRAIN_DATA_DIR=/lustrefs/users/haonan.li/data/k2/train_scored_dedup_am_12k_len_rm_flipscore_dpsk_jshape_no0_5_3
