#!/bin/bash
#SBATCH --job-name=rl-32b-k2think-continue-data5_1_math_code
#SBATCH --nodes=32
#SBATCH --ntasks=32
...
train_files="['${math_train1_path}', '${math_train2_path}', '${leetcode_train_path}', '${livecodebench_train_path}', '${primeintellect_train_path}', '${taco_train_path}', '${arcagi1_train_path}' ]"  # Use math as example, add to more tasks as needed
# test_files="['${math_train1_path}']"
test_files="['${aime25_test_path}', '${amc_test_path}', '${aime_test_path}', '${math_test_path}', '${humaneval_test_path}','${livecodebench_test_path}','${reasoning_gym_test_path}','${gpqa_diamond_test_path}','${ifeval_test_path}']"  # Use math as example, add to more tasks as needed test_files="['${supergpqa_test_path}','${ifeval_test_path}']"  # Use math as example, add to more tasks as needed
