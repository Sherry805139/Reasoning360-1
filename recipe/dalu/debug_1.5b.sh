...
TRAIN_DATA_DIR=/mnt/sharefs/users/chengqian.gao/guru/train
TEST_DATA_DIR=/mnt/sharefs/users/chengqian.gao/dalu/eval

# Math (train)
math_train1_path=${TRAIN_DATA_DIR}/math__deepscaler_8192.parquet

# Math (test)
test_aime24=${TEST_DATA_DIR}/aime24_x32.parquet
test_aime25=${TEST_DATA_DIR}/aime25_x32.parquet
...
test_files="['${test_amc23}', '${test_olympiadbench}']"  # Use math as example, add to more tasks as needed
...
# =================== Logging ===================
WANDB_PROJECT=Reasoning360-1.5B-Distill
