...
# model
model_path=fengyao1909/full_s1_sl16k_bs32_lr1e-5_ckpt140
model_name="full_s1_sl16k_bs32_lr1e-5_ckpt140_0708"  # this will be the folder name under the save_folder
...
top_p=0.8
prompt_length=1024
response_length=7168  # 32768 - 1024, Qwen3-moe only has 32768 max len
max_num_batched_tokens=65536 # 786432  # 2 x context length
