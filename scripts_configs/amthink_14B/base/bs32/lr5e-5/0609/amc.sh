...
# model
model_path=fengyao1909/full_s1_sl16k_bs32_lr5e-5_ckpt140
model_name="full_s1_sl16k_bs32_lr5e-5_ckpt140_0609"  # this will be the folder name under the save_folder
