...
# model
model_path=fengyao1909/full_s1_sl16k_bs16_lr5e-5_gate_ckpt285
model_name="full_s1_sl16k_bs16_lr5e-5_gate_ckpt285_1007"  # this will be the folder name under the save_folder
