...
# model
model_path=fengyao1909/full_amthink_sl16k_bs64_lr5e-5_ckpt1044
model_name="qwen3-30b-full_amthink_ckpt1044_0609"  # this will be the folder name under the save_folder
