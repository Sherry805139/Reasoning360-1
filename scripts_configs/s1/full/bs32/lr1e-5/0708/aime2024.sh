...
# model
model_path=fengyao1909/full_s1_sl16k_bs32_lr1e-5_ckpt285
model_name="full_s1_sl16k_bs32_lr1e-5_ckpt285_0708"  # this will be the folder name under the save_folder
...
max_num_batched_tokens=983040 # 786432  # 2 x context length
