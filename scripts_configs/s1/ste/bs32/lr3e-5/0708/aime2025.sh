...
# model
model_path=fengyao1909/ste_s1_sl16k_bs32_lr3e-5_ckpt285
model_name="ste_s1_sl16k_bs32_lr3e-5_ckpt285_0708"  # this will be the folder name under the save_folder
