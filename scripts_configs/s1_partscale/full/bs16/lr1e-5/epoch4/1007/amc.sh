...
# model
model_path=fengyao1909/full_s1_sl16k_bs16_lr1e-5_ckpt228
model_name="full_s1_sl16k_bs16_lr1e-5_ckpt228_1007"  # this will be the folder name under the save_folder
