...
# model
model_path=fengyao1909/full_s1_sl16k_bs16_lr3e-5_gate_fixed_ckpt285
model_name="full_s1_sl16k_bs16_lr3e-5_gate_fixed_ckpt285_0708"  # this will be the folder name under the save_folder
