...
# model
model_path=fengyao1909/ste_s1_sl16k_bs16_lr5e-6_gate_fixed_ckpt285
model_name="ste_s1_sl16k_bs16_lr5e-6_gate_fixed_ckpt285_1007"  # this will be the folder name under the save_folder
