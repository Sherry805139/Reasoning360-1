...
# model
model_path=fengyao1909/ste_s1_sl16k_bs16_lr1e-5_zero3_gate_fixed_ckpt285
model_name="ste_s1_sl16k_bs16_lr1e-5_zero3_gate_fixed_ckpt285_0708"  # this will be the folder name under the save_folder
