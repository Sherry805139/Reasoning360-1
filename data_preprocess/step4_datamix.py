...
def process_all_files(source_folder, target_folder):
    ...
    files_to_process = {
        ...
        "simulation__codeio_fixed_12.1k.parquet": 0.1,
        "logic__reasoning_gym_40.6k.parquet": 0.3,
        "logic__synlogic_12.1k.parquet": 0.3,
        "ifbench__fixed_85.6k.parquet": 0.1
    }
    ...
    for math_file in math_files:
        ...
        if os.path.exists(source_path):
            ...
            rows = len(ds)
            math_total_rows += rows
    print(f"  Total math rows: {math_total_rows}")
...
def main():
    ...
    for i, (source_folder, target_folder) in enumerate(zip(source_folders, target_folders), 1):
        ...
        process_all_files(source_folder, target_folder)
